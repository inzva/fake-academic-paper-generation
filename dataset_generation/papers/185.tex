...
% 2. 과거의 방법들은 해상도 차이만이 있기 때문에, 주로 해상도에 따른 차이만을 교정했다.
...
% 3. 하지만 CNN 기반의 Detection Method 들은 일반적으로 Scale Normalization을 하지 않기 때문에 Scale에 따른 새로운 차이가 존재하게 된다.
...
% 4. 우리는 이러한 차이를 교정하기 위해 그것을 학습하는 SAN을 제안한다. (FIG1)
...
\begin{figure}[t]
	...
	%testing 이랑 training을 색 기준으로 나눠서 한쪽에서만 작동함을 설명하자
	\centering
	\label{fig:SAN_scale}
\end{figure}
