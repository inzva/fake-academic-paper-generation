...
%\definecolor{classify_color}{rgb}{1.0, 0.88, 0.21}
...
%% ====================End define deep learning block
...
%\node (copy_def_text) [right,above= 1.6cm and 1.2cm of conv_copy] {Copy};
...
%\node (deconv_def_text) [right, above= 1.2cm and 2.3cm of deconv2] {Upsampling};
