% -*- mode: latex; mode: reftex; mode: flyspell; mode: auto-fill; TeX-master: "top.tex"; -*-
...
% If you comment ref and then uncomment it, you should delete
...
%%%%%%%%% BODY TEXT
% -*- mode: latex; mode: reftex; mode: flyspell; mode: auto-fill; TeX-master: "top.tex"; -*-\section{Introduction}
...
% -*- mode: latex; mode: reftex; mode: flyspell; mode: auto-fill; TeX-master: "top.tex"; -*-\section{Related Work}\label{sec:related}
...
% -*- mode: latex; mode: reftex; mode: flyspell; mode: auto-fill; TeX-master: "top.tex"; -*-\section{Active Learning for Delineation}\label{sec:delin}
...
\end{figure}
% -*- mode: latex; mode: reftex; mode: flyspell; mode: auto-fill; TeX-master: "top.tex"; -*-\section{Approach}\label{sec:approach}
...
%--------------------------------------------------------------------------\subsection{Probability Propagation}\label{sec:propagation}
...
%Suppose some edge has got a high entropy value, but at the same time the classifier is certain about its neighbours and they are assigned to the same class. We may assume that the uncertain edge also belongs to the same class and it may be more beneficial to query other uncertain edge, but which is in uncertain neighbourhood. Now, consider the case where we have two samples with the same entropy value, but one of them is surrounded by confident samples belonging to the same class, while the other is in neighbourhood of samples with different labels. In this situation we may prefer to query the second example, as it might help to refine the border between structure of interest and background.
...
% -*- mode: latex; mode: reftex; mode: flyspell; mode: auto-fill; TeX-master: "top.tex"; -*-\section{Results}\label{sec:results}\begin{figure*}[t]
\centering
...
\label{fig:longQuery}
\end{figure}
% -*- mode: latex; mode: reftex; mode: flyspell; mode: auto-fill; TeX-master: "top.tex"; -*-\section{Conclusion}\label{sec:conclusion}
