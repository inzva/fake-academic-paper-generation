...
%LC : il faut que tu ajoutes une remarque sur les autres papiers et l'absnece de facteur d'chelle dans l'intro, pour que ce soit bien clair que ce que tu fais est mieux. explain "the scale factor problem"
...
%AM: l'expression "the same for translation" est ambigu ; est-ce qu'on pourrait crire
...
%AM: a me parat un peu compliqu dit comme a ; on peut avoir l'impression au dbut
%AM: que tu inventes une nouvelle mtrique qui t'arrange, alors que c'est au contraire
%AM: une mtrique plus juste. D'autre part je trouve que les notations "D" et "P" ne
%AM: sont pas trs parlantes. Est-ce que ce ne serait pas plus clair de prciser si
%AM: le facteur d'chelle est fourni par la vrit terrain "GT" ou par la vitesse "S" ??
...
%AM: l'estimation de la "moyenne" en convoluant avec une gaussienne est  peu prs
%AM: vidente, mais pour la (co)variance a l'est moins... est-ce que tu calcules directement
%AM: la moyenne dans le vois 3x3 des carrs (et produits) pondrs par la gaussienne ?
...
%AM: fonctions de loss photomtriques, pourquoi pas SSIM seule ?
...
% ce n'est pas clair que c'est le cas pour l'autre papier. Au passage, est ce que DepthNet est meilleur si on applique le ratio des mdianes? est ce que tu aurais le temps de tester?
%LC: peut tre changer l'ordre en mettant la 2eme phrase (However, when scale factor...)  la fin du paragraphe ?
