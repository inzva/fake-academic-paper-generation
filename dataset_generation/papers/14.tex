...
%\todo{references added as \cite{paperlabel} you should make a bibfile in your project}
...
%We have trained our model on train and test on DRISHTI GS1 dataset and evaluated on RIM-ONE dataset.
...
%\todo{add results of one common segmentation model and on the baseline methods with explanation}
