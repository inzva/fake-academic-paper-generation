...
%\title{MCar with ICE}
%\title{Learning from Imbalanced \\ Ambiguously Labeled Data}
...
\begin{figure*}
        ...
        \begin{subfigure}[b]{0.32\textwidth}
                %\includegraphics[width=\textwidth]{figure/FIW_p1plot.eps}
                \includegraphics[trim=10 3 18 19,clip,width=\textwidth]{FIW_p1plot.eps}
                %\caption{$\alpha= 0.0 : 0.95$, $\beta =2 $ for FIW10b, inductive}
        ...
        \begin{subfigure}[b]{0.32\textwidth}
                ...
                %\caption{$\alpha= 1.0$, $\beta =1$, $\epsilon \in [1/(c-1), 1]$ for FIW10b, inductive}
                %\label{fig:R0_far}
       ...
       \begin{subfigure}[b]{0.32\textwidth}
                ...
                %\caption{$\alpha = 1$, $\beta = 0:9$ for FIW10b, \textcolor[rgb]{1.00,0.00,0.00}{transductive or inductive (run exp for CLPL)}}
                %\label{fig:initialL0}
