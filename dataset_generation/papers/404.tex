...
% The main culprit is the interference between the pixel grids of the
% display screen (as shown in Fig.~\ref{fig:synth_lcd}) and camera
% sensor array (as shown in Fig.~\ref{fig:synth_cam}), which generates
% objectionable moir\'e (aliasing) patterns.
...
\begin{figure}
  ...
  % \begin{subfigure}[t]{0.32\linewidth}
  %   \centering
  %   \includegraphics[width=\linewidth]{exp/346_our}
  %   \caption{Moir\'e artifacts removed image}
  % \end{subfigure}
