...
%\author{Amit Kumar \hskip7pt  Rajeev Ranjan \hskip7pt Vishal M. Patel \hskip7pt Rama Chellappa\\
%Center for Automation Research\\
%University of Maryland, College Park, MD 20742\\
%{\tt\small\{akumar14, rranjan1, pvishalm, rama\}@umiacs.umd.edu}
%}
...
%\centering CFSS \cite{Zhu_2015_CVPR}                        & \centering 4.87            & \centering 3.78 \\
\hline
...
%We presented a method of using \textbf{Deep Descriptors} for highly accurate image alignment producing state of the art result. The highly informative nature of \textit{deep descriptor} makes it useful as SIFT, SURF and HOG features. This means \textit{deep descriptors} have potential in many different kinds of application in machine vision, such as pose estimation, activity recognition and human detection and many others. Also performing only global regression makes it a fast algorithm. 
