...
\label{table:protocol1_gt}
	...
	\begin{tabularx}{\textwidth}{ l *{8}{Y} }
		...
		%\midrule
		%GT2D n n &63.85 &58.01 &70.49 &75.29 &70.36 &70.67 &61.02 &68.66 &92.45 \\
...
%		\midrule
		%CPM2D n n &76.98 &73.54 &79.73 &85.33 &76.14 &76.51 &\textbf{85.91} &\textbf{89.25} &\textbf{166.50} \\
...
%		\midrule
		%CPM2D n n&89.41 &101.42 &77.42 &58.09 &86.62 &68.07 & 85.52 & 75.04&- \\
...
\subsection{Quantitative Results: Protocol 2}\begin{table*}[htb!]
	...
	\centering
		...
		%Forward2Dto3D~\cite{Tung_2017_ICCV} & 75.2 & 118.4 & 165.7 & 95.9 & 149.1 & 154.1 & 77.7 & 176.9 \\
		...
		\midrule
		%Forward2Dto3D~\cite{Tung_2017_ICCV} & 186.5 & 193.7 & 142.7 & 99.8 &  74.7 &  - & - &128.9\\
...
\end{table*}\begin{table*}[t]
	...
	\begin{tabularx}{\textwidth}{ l *{8}{Y} }
		...
		\midrule
		%& Direct & Discuss & Eat & Greet & Phone & Photo & Pose & Purchase & Sit & SitDown & Smoke & Wait& Walk &  Average\\
		%Forward2Dto3D~\cite{Tung_2017_ICCV} & 80.2 & 92.4 & 102.8 & 92.5 & 115.5 & 79.9 & 119.5 & 136.7\\
		...
		% Zhou~\etal~(2017)~\cite{Towards_wild_Zhou} $^{\dagger}$ & {\bf 54.82} & {\bf 60.7} & {\bf 58.22} & 71.41 & {\bf 63.03} & 65.53 & {\bf 53.83} & {\bf 55.58} \\
		...
		Method & Sit & SitDown & Smoke & Wait & Walk & WalkD & WalkP & Avg.\\
		\midrule
		%Forward2Dto3D~\cite{Tung_2017_ICCV} & 136.7& 144.4 & 109.3 & 94.2 & 80.2  &  - & - & 104.6\\
		...
		% Zhou~\etal~(2017)~\cite{Towards_wild_Zhou} $^{\dagger}$ &75.20 & 111.59 & {\bf 64.15} & 66.05 & {\bf 51.43} & {\bf 63.22} & {\bf 55.33} & 64.9 \\
...
\label{table:P2_sh_supervisedcomparison}
	...
	\begin{tabularx}{\textwidth}{ l *{8}{Y} }
		...
		% Moreno-Noguer~\cite{distance-matrix} (SA) 14j & 69.5 & 80.2 & 78.2 & 87.0 & 100.8 & 102.7 & 76.0 & 69.7 & 104.7 & 113.9 & 89.7 & 98.5 & 79.2 & 82.4 & 77.2 & 87.3\\
		% Newer CVPR version
		% Moreno-Noguer~\cite{distance-matrix} (SA) 14j & 67.5 & 79.0 & 76.5 & 83.1 & 97.4 & 74.6 & 72.0 & 102.4 & 116.7 & 87.7 & 100.4 & 94.6 & 75.2 & 82.7 & 74.9 & 85.6\\
...
\end{figure}\begin{figure}[htb]
	\centering
	% trim={<left> <lower> <right> <upper>}
%	\includegraphics[width=0.97\linewidth]{images/h36m_failure}
