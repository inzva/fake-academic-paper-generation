...
% \author{Panqu Wang\\
% TuSimple\\
% {\tt\small panqu.wang@tusimple.ai}
% \and
% Pengfei Chen\\
% TuSimple\\
% {\tt\small pengfei.chen@tusimple.ai}
% \and
% Ye Yuan\\
% Carnegie Mellon University\\
% {\tt\small yey1@andrew.cmu.edu}
% \and
% Ding Liu\\
% UIUC\\
% \and
...
\begin{figure*}[t]
\begin{center}
% \includegraphics[width=0.99\textwidth]{\string"cvpr_2017_submission_figure_1\string"}
