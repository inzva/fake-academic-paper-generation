...
%"Can we learn some data-driven riteria instead of the hand-crafted criteria and get better question?"
%"How to control the tradeoff between network performance and scale during pruning"
...
%\textbf{Connection to traditional reinforcement learning.} Although the policy gradient estimation method  is also widely used in reinforcement learning tasks, our problem formulation differs from them in that our input to agent is fixed. Our problem is more like a single step agent.
