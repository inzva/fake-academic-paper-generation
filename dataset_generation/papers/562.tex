...
%\begin{figure}[!t]
%\centering
%\subfloat[]{\includegraphics[width=0.33\columnwidth]{train_22.png} \label{fig:detection1}}
%\subfloat[]{\includegraphics[width=0.33\columnwidth]{train_78.png} \label{fig:detection2}}
%\subfloat[]{\includegraphics[width=0.33\columnwidth]{train_16.png} \label{fig:detection3}}
%\caption{(a) Well differentiated CRA H\&E image tile, (b) Moderately differentiated CRA H\&E image tile, (c) Poorly differentiated CRA H\&E image tile. Gland boundaries, as annotated by an expert pathologist are shown in green.}
%\label{fig:detection}
%\end{figure}
...
\end{equation}
%\sum_{a=1}^{2}(w_{a}\log p_a(x;W_a)) + \log p_c(x;W_c) + \log p_o(x;W_o) + w_i(x)\log p_i(x;W_i)
