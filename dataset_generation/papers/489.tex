...
%\author[mysecondaryaddress]{Guoliang Fan}
...
%\address[mysecondaryaddress]{School of Electrical and Computer Engineering, Oklahoma State University\\
...
\hline
% Databases & \tabincell{l}{Classes/Total \\Sample Number} & \tabincell{l}{Sample \\Number Each Class}& Extracted Features\\
