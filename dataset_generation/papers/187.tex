...
% The paper headers
%\markboth{IEEE TRANSACTIONS ON MEDICAL IMAGING, TMI-2018-1349}%
%{Krebs \MakeLowercase{\textit{et al.}}: Learning a Probabilistic Model for Diffeomorphic Registration}
...
%&= \int_z \int_{v^*} p(F|v^*,M)~p(v^*|v)~p(z)~dv^*~dz\nonumber\\
