...
\usepackage{leftidx}
\usepackage{pifont}
%\usepackage[square, comma, sort&compress, numbers]{natbib} % For continuous reference numbers
...
% The paper headers
%\markboth{A SUBMISSION TO IEEE TRANSACTION ON IMAGE PROCESSING}%
\markboth{}%
...
\end{proof}
  ...
  %\ \ \ \ $f_T \leftarrow \mathcal N_h(\bm x)$;
  \STATE
...
%\scriptsize
\small
%\caption{Accuracies obtained by different networks trained on three datasets with different SNR values.}
