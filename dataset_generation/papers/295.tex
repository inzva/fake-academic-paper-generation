...
%
\institute{PSL, Université Paris-Dauphine, LAMSADE, CNRS, UMR 7243, Paris, France
\and
...
Later in \cite{Huhtanen2015}, Huhtanen and Perämäki have demonstrated that choosing $m=n$ is sufficient to decompose  % for Equation~\ref{eq:general_framework} to hold for any 
