...
%\titleheader{National Aerospace & Electronics Conference (NAECON) 2018}
...
%\begin{tabular}{cc}
%\includegraphics[scale=0.145]{data1.png}& %\includegraphics[scale=0.145]{data2.png}\\
%\vspace{.5mm}
%\end{tabular}
%\begin{tabular}{cc}
% \includegraphics[scale=.145]{data3.png}&
% \includegraphics[scale=.145]{data4.png}
%\end{tabular}
...
% that's all folks
\end{document}
% * <amirsol2003@gmail.com> 2018-08-26T07:12:49.320Z:
%
% ^.
