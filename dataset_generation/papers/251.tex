...
%\def\iccvPaperID{2785} % *** Enter the ICCV Paper ID here
...
% \begin{figure}
% \centering{}{\small{}\includegraphics[scale=0.25]{fig/visualization/casia_vis}\caption{\label{fig:Results-of-casia}Results of modifying attributes on CASIA-WebFace
% dataset. Each column indicates modifying by adding one type of attribute
% to image, while the red box means the image is modified to not have
% that attribute. }
% } 
