...
%\copyright 2018 IEEE. Personal use of this material is permitted. Permission
...
\begin{table}
%\caption{Approximated convolution through forward and backward method during \textbf{train-time}}
\label{Algorithm 1}
...
% To match the process about \textbf{Train-time}
