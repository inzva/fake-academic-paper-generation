...
parser.add_argument('--dataset', type=str, default='wt103',
                    choices=['wt103', 'lm1b', 'enwik8', 'text8', 'papers', 'generic_dataset'],
                    help='dataset name')
...
def train():
    ...
    global train_step, train_loss, best_val_loss, eval_start_time, log_start_time, best_cur_loss
    model.train()
    ...
    for batch, (data, target, seq_len) in enumerate(train_iter):
        ...
        if train_step % args.log_interval == 0:
            ...
            if args.dataset in ['enwik8', 'text8', 'papers']:
        ...
        if train_step % args.eval_interval == 0:
            ...
            if not best_cur_loss or cur_loss < best_cur_loss:
                if not args.debug:
                    with open(os.path.join(args.work_dir, 'model_best_train.pt'), 'wb') as f:
                        torch.save(dict(
                            model_params=model_params,
                            state_dict=model.state_dict(),
                            vocab=corpus.vocab.idx2sym,
                    ...
                    with open(os.path.join(args.work_dir, 'optimizer_best_train.pt'), 'wb') as f:
                        torch.save(optimizer.state_dict(), f)
                best_cur_loss = cur_loss
