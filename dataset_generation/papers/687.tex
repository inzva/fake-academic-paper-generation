...
% !TEX root = ../main_imu.tex\usepackage{booktabs}% For formal tables\usepackage{caption}\usepackage{subcaption}%===========================================================% newly added by Yinghao\usepackage{soul,xcolor}\usepackage{pdfpages}\usepackage{tikz}%===========================================================% TOG prefers author-name bib system with square brackets\citestyle{acmauthoryear}\setcitestyle{square}\usepackage[ruled]{algorithm2e}% For algorithms\renewcommand{\algorithmcfname}{ALGORITHM}\SetAlFnt{\small}\SetAlCapFnt{\small}\SetAlCapNameFnt{\small}\SetAlCapHSkip{0pt}\IncMargin{-\parindent}\DeclareMathOperator*{\argmin}{arg\,min}\DeclareMathOperator*{\argmax}{arg\,max}\usepackage{multirow}\usepackage{graphicx}%\usepackage[table,xcdraw]{xcolor}\usepackage{wrapfig}\usepackage[percent]{overpic}\usepackage{caption}% http://ctan.org/pkg/caption\usepackage{subcaption}\usepackage{float}\usepackage{stackengine}\usepackage{color}\usepackage{paralist}\usepackage{balance}%\usepackage{enumitem}\usepackage{units}\usepackage{amsmath}\usepackage{amssymb}\widowpenalty 10000
\clubpenalty 10000
...
% !TEX root = ../main_imu.tex\begin{abstract}
...
% !TEX root = ../main_imu.tex\section{Introduction}%Motivation
...
% !TEX root = ../main_imu.tex\section{Method overview}
...
% !TEX root = ../main_imu.tex\section{Implementation Details}\subsection{Network architecture}
...
% !TEX root = ../main_imu.tex\section{Experiments}
...
% !TEX root = ../main_imu.tex\subsection{Quantitative evaluation}\label{sec:quant_eval}
...
\end{table*}\begin{table*}[ht]
	...
	\begin{tabular}{l | c c c c | c c c c}
		...
		& $\mu_{ang}$[deg] & $\sigma_{ang}$[deg] & $\mu_{pos}$[cm] & $\sigma_{pos}$[cm] & $\mu_{ang}$[deg] & $\sigma_{ang}$[deg] & $\mu_{pos}$[cm] & $\sigma_{pos}$[cm] \\
		\hline
		% RNN & 16.08 & 13.46 & 6.21 & 6.27 & \added{30.90} & \added{18.66} & 11.84 & 8.59 \\
        % \added{BiRNN} & 15.85 & 12.87 & 5.98 & 6.03 & \added{31.70} & \added{17.30} & 12.07 & 8.72  \\ 
...
% !TEX root = ../main_imu.tex\section{Conclusion and Future Work}
...
% !TEX root = ../main_imu.tex\appendix\section{Additional Architectures}\label{sec:additional_architectures}
