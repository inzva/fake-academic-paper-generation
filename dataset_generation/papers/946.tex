...
% Single address.
% ---------------
%\name{Jia-xin Cai, Xin Tang, Guocan Feng, Lifang Zhang}
%\address{Xiamen University of Technology, Xiamen, China\\
...
%Lu and Peng \cite{Lu2013} propose a structure sparsity $\ell_1$-norm graph  to learn the high-level visual-words for representing human action.
%Qiu et al.\cite{Qiu2011} build a compact and discriminative action attribute dictionary  by minimizing the reconstruction error and  Gaussian Process model.
...
% \begin{equation} \label{eq5}
% \begin{aligned}
%x_{c}=\frac{\sum_{k=1}^{n}x(k)}{n} \ \ \ \ \ \  y_{c}=\frac{\sum_{k=1}^{n}y(k)}{n}
% \end{aligned}
%\end{equation}
...
%A two-phase discriminative dictionary framework is learnt on the fractional Fourier descriptor for recognizing action videos.
%Firstly, the discriminative frames of the training set are selected  by Gentle Adaboost algorithm  to learn the first layer dictionary.
%The left undiscriminating training frames, representing noise , clutter, redundant and common components among different actions, are relabeled and assigned to the "zeroth" class.
%Then for all frames, the reconstruction errors corresponding to each dictionary atom are collected to build a new representation.
%After the representation of all frames are computed, the class-specific dictionary learning is performed on the new representation to obtain the sparse codes of the tested frames.
%The "zeroth" class is used for recognizing and filtering the undiscriminating frames of the test video.
%The final action label is voted by all remained discriminative frames of test video.
...
%However, note that we have defined the zeroth class.
...
%The K-SVD \cite{AharonKSVD} and OMP \cite{Pati93orthogonalmatching} algorithm are performed for learning dictionary and sparse representation respectively.
...
%    Class-specific Dictionary Learning (sum pooling) & 91.40\% & 88.97\%\\
%    Class-specific Dictionary Learning (max pooling) & 88.17\% & 88.97\%\\
%    Two-phase Dictionary Learning (sum pooling)  & 89.24\% & 86.02\%\\
%    Two-phase Dictionary Learning (max pooling)  & 89.24\% & 86.02\%\\
 %    Cheng et al. \cite{ChengMVA2014} & 93.18\% &  \\
...
%     Zhao and Horace \cite{Zhao2013}  & 87.50\% &   \\
     %    Eweiwi et al. \cite{Eweiwi}  & 100.00\%  & 91.90\%\\
        \bottomrule
    \end{tabular}%
  \label{tab:recresult}%
\end{table}%
...
%\small
%\centering
%\includegraphics[height=3.5cm]{paraDweiz.eps}
%\caption{Relation between accuracy(\%)  on Weizmann dataset and the number of atoms of the first phase dictionary}
%\label{Fig3}
%\end{figure}
%
%
...
%\small
%\centering
%\includegraphics[height=3.5cm]{paraDmas14.eps}
%\caption{Relation between accuracy(\%)  on MuHAVI-MAS14 dataset and the number of atoms of the first phase dictionary}
%\label{Fig3}
%\end{figure}
%
%
...
%\small
%\centering
%\includegraphics[height=3.5cm]{para0atomweiz.eps}
%\caption{Relation between accuracy(\%) on Weizmann dataset and the atom number of the zeroth class  dictionary}
%\label{Fig3}
%\end{figure}
%
%\begin{figure}[htbp]
%\small
%\centering
%\includegraphics[height=3.5cm]{para0atommas14.eps}
%\caption{Relation between accuracy(\%) on MuHAVI-MAS14 dataset and the atom number of the zeroth class dictionary}
%\label{Fig3}
%\end{figure}
%
%
...
%\small
%\centering
%\includegraphics[height=3.5cm]{paraLweiz.eps}
%\caption{Relation between accuracy(\%)  on Weizmann dataset and the atom number  of  nonzero class dictionary}
%\label{Fig3}
%\end{figure}
%
%\begin{figure}[htbp]
%\small
%\centering
%\includegraphics[height=3.5cm]{paraLmas14.eps}
%\caption{Relation between accuracy(\%)  on MuHAVI-MAS14 dataset and the atom number  of  nonzero class dictionary}
%\label{Fig3}
%\end{figure}
%
%
