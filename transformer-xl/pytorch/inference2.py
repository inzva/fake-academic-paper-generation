...
if __name__ == '__main__':
	  model = ModelWrapper.load(model_path="experiments-papers/20190423-030812/model.pt", spm_path='m.model')
	  gen_iter = iter(model.sample_text_iter("8 101 103 105 110 123 100 111 99 117 109 101 110 116 125 10 9 105 116 108 101 123"))
	  print("\\begin{document}\n\\title{", end='')
	  f = open('generated_text.txt', 'w+')
	  for i in range(10000):
		    print(chr(int(next(gen_iter))), end='', file=f, flush=True)
