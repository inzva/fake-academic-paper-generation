...
\setcitestyle{square}
\usepackage{authblk}
% Make subsection text start on the same line.
...
%%SL.06.02: I like Grasp2Vec most, maybe something like Grasp2Vec: Deep Grasping Policies with Additive Group Embeddings
%%SL.06.02: though it would be good if the title somehow reflects the idea that it's learning object representations by grasping...
%%CD.06.08: Grasp2Object?
%%EJ.06.09: Grasp2Vec: Learning Object Representations via Grasping
       ...
       \begin{algorithm}[H]{\small
        ...
        \WHILE{$\pi$ not converged}
          ...
          \STATE \(\replaybuffer \gets \replaybuffer \bigcup (\bs, \ba, [\othergoal, \hat{\phig}(\outcome) \cdot \hat{\phig}(\othergoal)])\)
           ...
           % \STATE \(\replaybuffer \gets \replaybuffer \bigcup (\bs, \ba, [\othergoal, 0])\) (alternate goal is a failure)
...
%%SL.11.10: Err isn't that obvious from the technical sections?
...
% \caption{TODO: data collection setup.}
