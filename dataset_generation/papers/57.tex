...
% each social attribute, and average the correlation coefficients as an index for the reliability and consistency of these social traits.
...
%This can be thought of as a lower bound on the performance we can hope to achieve.
...
% We find the maximum of the average product of the activations from conv5\textunderscore2, the weights to fc\textunderscore pca, and the weight from that PC to the output. We use this to identify top 9 neurons at conv5\textunderscore2 that contribute most to the output neuron for each social feature. 
...
\label{fig:top-9}
\end{figure*}
%Additional results provided in supplemental material.
